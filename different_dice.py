...
die_2 = Die(10) # Cria uma instância de Die passando como argumento dez lados.

# Faz alguns lançamentos e armazena os resultados em uma lista.
results = []
for roll_num in range(50000): # Lançando o dado mil vezes e armazenamos o resultado de cada lançamento em uma lista.
...
hist.add('D6 + D10', frequencies) # Acrescenta uma série de valores ao gráfico
hist.render_to_file('different_dice_visual.svg') # Renderizamos o gráfico em um arquivo SVG, que espera
