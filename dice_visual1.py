...
for value in range(1, max_result + 1): # Percorre os valores possíveis.
...
hist.render_to_file('dice1_visual.svg') # Renderizamos o gráfico em um arquivo SVG, que espera
